<%@ Control Language="C#" AutoEventWireup="true" Inherits="Admin.ExtensionManager.UserControlsXmanagerParameters" Codebehind="~/admin/Extension Manager/Settings.ascx.cs" %>
