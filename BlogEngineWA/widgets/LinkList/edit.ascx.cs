...
namespace BlogEngineWA.widgets.LinkList
{
    /// <summary>
    /// The widgets link list_edit.
    /// </summary>
    public partial class Edit : WidgetEditBase
    {
        ...
        private void GridRowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                var id = (string)row.Value;
                var textboxTitle = (System.Web.UI.WebControls.TextBox)this.grid.Rows[e.RowIndex].FindControl("txtTitle");
                var textboxUrl = (System.Web.UI.WebControls.TextBox)this.grid.Rows[e.RowIndex].FindControl("txtUrl");
